...
%     fig_level_scheme.pdf      (Fig. 1 -- level scheme; TO BE DRAWN, stubbed below)
%
...
\textsf{[Fig.~1 placeholder] Level scheme: the field-insensitive clock pair
$\ket{1,-1}/\ket{2,+1}$, the two $\Dm{=}2$ Raman legs through $\ket{F',0}$ of $5P_{3/2}$, the
dark-state geometry, and the cancelling $F'{=}1,2$ contributions ($g_1=-g_2$).}
\vspace{2.2cm}}}
\caption{\label{fig:levels} Level scheme and geometry of the $\Dm=2$ clock-pair Raman, with the
rank-2 null $g_1=-g_2$ indicated. \emph{(To be drawn.)}}
\end{figure}
