...
![Single-ended floor vs retro reflectivity — flat at a 400 MHz tag](../figures/fig_retro_flatness.png)
...
![Cloud floor vs radial temperature — the realized dynamic MC sits below the quasi-static column](../figures/fig_cloud_floor.png)

*The on-figure values are the older **3-level** semiclassical MC (Gaussian trap) and **predate the multilevel retraction** — treat them as superseded, not as the cloud headline. Current canonical cloud floors are **cooled box 0.0072 [V] / uncooled ≥0.021 [O]** (the §8 [UPDATE 2026-06-23] banner below, and [INDEX §1b](../INDEX.md)); a refreshed multilevel figure is queued.*
